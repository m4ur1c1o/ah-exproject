...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { dose: @treatment.dose, medicament: @treatment.medicament, weight: @treatment.weight }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { dose: @treatment.dose, medicament: @treatment.medicament, weight: @treatment.weight }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
